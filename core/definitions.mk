...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) asm:"${CL_RST}" $(PRIVATE_MODULE) <= $<"
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Strip (mini debug info):"${CL_RST}" $(PRIVATE_MODULE) ($@)"
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Pack Relocations:"${CL_RST}" $(PRIVATE_MODULE) ($@)"
$(copy-file-to-target)
...
@echo "$($(PRIVATE_PREFIX)DISPLAY) "${CL_CYN}"Prebuilt:"${CL_RST}" $(PRIVATE_MODULE) ($@)"
$(copy-file-to-target)
endef
