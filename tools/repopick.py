...
if __name__ == '__main__':
    # Default to PureFusion Gerrit
    default_gerrit = 'http://review.purefusionos.com'

    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        repopick.py is a utility to simplify the process of cherry picking
        patches from PureFusion Gerrit instance (or any gerrit instance of your choosing)
    ...
    default_revision = xml_root.findall('.//*[@name="purefusionos"]')[0].get('revision').split('/')[-1]
